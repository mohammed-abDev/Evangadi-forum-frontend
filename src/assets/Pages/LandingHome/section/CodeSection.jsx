      ...
      <div className={style.hero_container_title}>
        <div className={style.title_wrapper}>
          <h1 className={style.main_title}>
            How to Use <br /> Evangadi Forum Q&A
          </h1>
          ...
          <div className={style.content_wrapper}>
            ...
            <div className={style.code_sidebar}>
              <div className={style.sidebar_tabs}>
                <div className={`${style.tab} ${style.active}` }>User Registration</div>
                <div className={style.tab} onClick={()=>navigate('/login')}>
                  User Login</div>
                <div className={style.tab} onClick={()=>navigate('/ask')}>Asking a Question</div>
                <div className={style.tab} onClick={()=>navigate('/bot')}>🤖 Asking Evangadi bot</div>
                <div className={style.tab} onClick={()=>navigate('/home')}>Viewing Q&A</div>
                <div className={style.tab} onClick={()=>navigate('/question/:question_id')}>Submitting an Answer</div>
            ...
            <div className={style.code_content}>
              <div className={style.code_header}>
                <div className={style.code_dots}>
                  <span className={style.dot} style={{ background: "#ff5f56" }}></span>
                  <span className={style.dot} style={{ background: "#ffbd2e" }}></span>
                  <span className={style.dot} style={{ background: "#27ca3f" }}></span>
                </div>
              ...
              <div className={style.code_body}>
                ...
                <div className={style.code_line}>
                  ...
                  <span className={style.code_keyword}># User Registration</span>
                </div>
                ...
                <div className={style.code_line}>
                  ...
                  <span className={style.code_text}>Follow these steps:</span>
                </div>
